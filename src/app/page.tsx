...
export default function Home() {
  ...
  const getSeverityColor = (severity: string) => {
    switch (severity) {
      ...
      case 'hint': return 'text-green-600 dark:text-green-400';
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                      ...
                      <div className="space-y-2">
                        {contextualSuggestions.slice(0, 5).map((suggestion) => (
                          ...
                          >
                            <div className={`w-2 h-2 rounded-full mt-2 flex-shrink-0 ${getSeverityColor(suggestion.severity)}`}></div>
                            <div className="flex-1">
                              <div className="flex items-center gap-2 mb-1">
                                ...
                                <span className={`px-2 py-1 text-xs rounded-full ${getSeverityColor(suggestion.severity)}`}>
          ...
          <div className="mt-12 bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm">
                  Contextual suggestions as you type with inline editor decorations
                </p>
              </div>
              <div className="text-center">
                <div className="text-3xl mb-3">💡</div>
