...
describe('Home Page Integration', () => {
  ...
  it('shows loading state during analysis', async () => {
    mockFetch.mockImplementationOnce(() => new Promise(resolve => {
      setTimeout(() => resolve({
        ok: true,
        json: async () => ({ analysis: { score: 85, suggestions: [], metrics: { lines: 1, characters: 10, complexity: 1, maintainability: 'High' } } })
      }), 100)
    }))
  ...
  it('handles API errors gracefully', async () => {
    ...
    expect(screen.getByText('Enter your code and click "Analyze Code" to get started')).toBeInTheDocument()
  })
